...
Desktop/3. AFT using NSNSM/Simulation/n=400/censoring 60_/4.BJ.Rdata")
...
(apply(bias_normal4,2,mean) - beta_true) #* 100
(apply(bias_skewnormal4,2,mean) - beta_true) #* 100
(apply(bias_NSNSM4,2,mean) - beta_true) #* 100
(apply(bias_gee4,2,mean) - beta_true) #* 100
(apply(bias_gehan4,2,mean) - beta_true) #* 100
