...
(apply(bias_normal,2,mean) - beta_true) #* 100
(apply(bias_skewnormal,2,mean) - beta_true) #* 100
(apply(bias_NSNSM,2,mean) - beta_true) #* 100
(apply(bias_gee,2,mean) - beta_true) #* 100
(apply(bias_gehan,2,mean) - beta_true) #* 100
(apply(bias_BJ,2,mean) - beta_true) #* 100
...
for(i in 1 : iter){
	L2_normal[i,] = (abs(beta_true - beta_normal[[i]]))
	L2_skewnormal[i,] = (abs(beta_true - beta_skewnormal[[i]]))
	L2_NGSM[i,] = (abs(beta_true - beta_NGSM[[i]]))
	L2_NSNSM[i,] = (abs(beta_true - beta_NSNSM[[i]]))
	L2_gee[i,] = (abs(beta_true - beta_gee[[i]]))
	L2_gehan[i,] = (abs(beta_true - beta_gehan[[i]]))
}

apply(L2_normal, 2, mean) * 100
apply(L2_skewnormal, 2, mean) * 100
apply(L2_NGSM, 2, mean) * 100
apply(L2_NSNSM, 2, mean) * 100
apply(L2_gee, 2, mean) * 100
apply(L2_gehan, 2, mean) * 100
...
apply(L2_gee3, 2, mean)
apply(L2_gehan3, 2, mean)
